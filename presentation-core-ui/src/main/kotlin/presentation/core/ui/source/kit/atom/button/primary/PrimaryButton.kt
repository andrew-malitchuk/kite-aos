package presentation.core.ui.source.kit.atom.button.primary
 ...
 *
 * @param modifier Modifier to be applied to the [PrimaryButton].
 ...
 * @param corner The corner radius of the button. Default is dynamically calculated as half of the ButtonSize's minHeight.
...
public fun PrimaryButton(
    ...
    colors: ButtonColor = PrimaryButtonDefault.buttonColor(),
    sizes: ButtonSize,
    corner: Dp = sizes.minHeight / 2, // Dynamically calculate corner radius
