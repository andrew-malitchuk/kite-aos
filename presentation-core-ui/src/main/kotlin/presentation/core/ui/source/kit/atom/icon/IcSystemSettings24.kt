...
/**
 * 24dp system settings icon.
 *
 * @since 0.0.1
 */
public val IcSystemSettings24: ImageVector
    get() {
        if (_IcSystemSettings24 != null) {
            return _IcSystemSettings24!!
        }
        _IcSystemSettings24 =
            ImageVector.Builder(
                name = "IcSystemSettings24",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
                viewportWidth = 960f,
                viewportHeight = 960f,
...
private var _IcSystemSettings24: ImageVector? = null
