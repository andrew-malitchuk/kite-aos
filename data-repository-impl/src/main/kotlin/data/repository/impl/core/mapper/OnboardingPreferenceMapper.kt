...
internal object OnboardingPreferenceMapper :
    ...
    override val toModel: Mapper<OnboardingPreference, OnboardingModel> = Mapper { input ->
        OnboardingModel(
            isCompleted = input.isCompleted ?: false
        )
    }
    override val toResource: Mapper<OnboardingModel, OnboardingPreference> = Mapper { input ->
